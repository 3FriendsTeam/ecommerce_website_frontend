...
const Header = () => {
  ...
  return (
    <div className="relative max-w-full mx-auto">
      {/* banner */}
      <div className="relative w-full max-w-[1170px] mx-auto overflow-hidden">
        <button
          onClick={prevImg}
      ...
      <div
        ...
        className="flex flex-col md:flex-row md:h-16 items-center"
      >
        <div className="ml-4 md:ml-[183px]">
          <div className="border border-transparent rounded p-2 bg-transparent">
            <a href="/">
              <img src={logo} alt="logo" className="w-32 md:w-auto h-auto" />
            </a>
          </div>
        </div>
        ...
        <div
          className="text-xs text-white p-2 rounded-xl ml-4 w-auto md:w-[141px] h-[40px] mt-2 md:mt-0"
        ...
        <div
          className="text-xs text-white p-3 rounded-xl ml-4 w-auto md:w-[140px] h-[40px] mt-2 md:mt-0"
          style={{ backgroundColor: "#C81B1B" }}
        >
          <div className="flex justify-between items-center h-full">
